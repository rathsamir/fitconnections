<?php
class Fitconnections_Events_Model_Config extends Mage_Catalog_Model_Product_Media_Config {
    ...
    {
        return 'profileimages' . DS . $this->getBaseMediaPathAddition();
    }
    ...
    {
        return 'profileimages/' . $this->getBaseMediaUrlAddition();
    }

    public function getBaseMediaPath()
    {
        return Mage::getBaseDir('media') . DS . 'profileimages' . DS . 'events';
    }

    public function getBaseMediaUrl()
    {
        return Mage::getBaseUrl('media') . 'profileimages/events';
    }
